...
namespace Wacs.WASI.NN.HostBinding
{
    ...
    /// inlined here so this package doesn't depend on Preview2.
    /// Component-model guests export <c>cabi_realloc</c>; the
    /// host calls it to reserve guest memory for strings, lists,
    /// and aggregate retArea writes before lowering bytes back
    /// to the guest.
    /// </summary>
