...
namespace Wacs.WASI.NN.LlamaSharp.Test
{
    ...
    {
        // (Earlier `TryLoadAssembly_ResolvesKnownAndReturnsNullForBogus`
        // removed: WasiPreview2RuntimeScope.TryLoadAssembly was deleted
        // as part of the [WasiScopeBootstrap] attribute-driven
        // refactor — NNScopeBootstrap now walks
        // AppDomain.CurrentDomain.GetAssemblies() directly to find
        // IWasiNNBackendRegistration implementations, which inherently
        // covers both the default context and the LoadFromContext
        // (--bind <path>) case. The end-to-end behavior that test
        // guarded is covered by LoadByNameBackend_AutoWiredFromLlamaSharpAssembly
        // below.)
