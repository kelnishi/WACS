(module
  (import "wasi:filesystem/types@0.2.3" "[method]descriptor.set-times"
    (func $st (param i32 i32 i64 i32 i32 i64 i32 i32)))
  ...
  (func (export "ask-set-times") (param i32) (result i32)
    (local $r i32)
    (local.set $r (call $realloc (i32.const 0) (i32.const 0) (i32.const 1) (i32.const 2)))
    ;; atime = NoChange (disc=0, ignored seconds/nanos)
    ;; mtime = Timestamp(2000s, 0 nanos) (disc=2, seconds=2000)
    (call $st (local.get 0)
              (i32.const 0) (i64.const 0) (i32.const 0)
              (i32.const 2) (i64.const 2000) (i32.const 0)
              (local.get $r))
