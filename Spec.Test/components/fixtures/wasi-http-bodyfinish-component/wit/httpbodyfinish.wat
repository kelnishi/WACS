(module
  ...
  (func (export "ask-finish-none") (param i32) (result i32)
    (local $r i32)
    ;; result<_, error-code>: 2 bytes (disc + 1-byte enum payload)
    (local.set $r (call $realloc (i32.const 0) (i32.const 0) (i32.const 1) (i32.const 4)))
    ;; finish(body, None: disc=0, handle=0)
    (call $finish (local.get 0) (i32.const 0) (i32.const 0) (local.get $r))
    (i32.load8_u (local.get $r)))
  (func (export "ask-finish-some") (param i32 i32) (result i32)
    (local $r i32)
    (local.set $r (call $realloc (i32.const 0) (i32.const 0) (i32.const 1) (i32.const 4)))
    ;; finish(body, Some(trailers): disc=1, handle=trailers)
    (call $finish (local.get 0) (i32.const 1) (local.get 1) (local.get $r))
    (i32.load8_u (local.get $r))))
