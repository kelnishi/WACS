(module
  (import "wasi:filesystem/types@0.2.8" "filesystem-error-code"
    (func $fec (param i32 i32)))
  ...
  (func (export "ask-errcode") (param i32) (result i32)
    (local $r i32)
    ;; option<u8>: align 1, total 2 bytes
    (local.set $r (call $realloc (i32.const 0) (i32.const 0) (i32.const 1) (i32.const 2)))
    (call $fec (local.get 0) (local.get $r))
    (i32.or
      (i32.load8_u (local.get $r))
      (i32.shl (i32.load8_u offset=1 (local.get $r)) (i32.const 8)))))
