...
{
            long dividend = context.Stack.PopI64();
            long divisor = context.Stack.PopI64();
            if (divisor == 0) 
        ...
        {
            ulong dividend = context.Stack.PopI64();
            ulong divisor = context.Stack.PopI64();
            if (divisor == 0) 
                throw new InvalidOperationException("Cannot divide by zero");
