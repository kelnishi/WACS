...
static List<ModuleSpec> ParseSpecs(string[] args)
{
    ...
    {
        new("coremark",    "Wacs.Console/Wacs.Console/Data/coremark.wasm",    null, true, 120_000, null, false),
        new("wasm2wat",    "Wacs.Console/Wacs.Console/Data/wasm2wat.wasm",    null, true, 120_000,
            new[] { "wasm2wat", "Wacs.Console/Wacs.Console/Data/coremark.wasm" }, false),
        new("perl",        "Wacs.Console/Wacs.Console/Data/andrewsample/perl.wasm", null, true, 120_000,
